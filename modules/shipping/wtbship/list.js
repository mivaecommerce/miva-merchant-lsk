...
// Weight Table Based Shipping List
////////////////////////////////////////////////////

function WeightTableBasedShippingList()
{
	MMBatchList.call( this, 'mm9_batchlist_weighttablebasedshippinglist' );
...
DeriveFrom( MMBatchList, WeightTableBasedShippingList );

WeightTableBasedShippingList.prototype.onLoad = WeightTableBasedShippingMethodList_Load_Query;

WeightTableBasedShippingList.prototype.onCreate = function()
{
	var record;
...
WeightTableBasedShippingList.prototype.onInsert = function( item, callback, delegator )
{
	WeightTableBasedShippingMethod_Insert( item.record.mmbatchlist_fieldlist, callback, delegator );
}

WeightTableBasedShippingList.prototype.onSave = function( item, callback, delegator )
{
	WeightTableBasedShippingMethod_Update( item.record.id, item.record.mmbatchlist_fieldlist, callback, delegator );
}

WeightTableBasedShippingList.prototype.onDelete = function( item, callback, delegator )
{
	WeightTableBasedShippingMethod_Delete( item.record.id, callback, delegator );
}

WeightTableBasedShippingList.prototype.onProcessLoadedData = function( recordlist, start_index )
{
...
WeightTableBasedShippingList.prototype.onRetrieveChildBranch = function( item )
{
	if ( !item || !item.root )
	{
		return null;
...
WeightTableBasedShippingList.prototype.onFindIndex_Params = function( item )
{
	return { 'Code': item && item.record ? item.record.code : '' };
}

WeightTableBasedShippingList.prototype.onFindIndex_Compare = function( item, params )
{
...
WeightTableBasedShippingList.prototype.EnableDisableButtons_AddHook = function()
{
	var item;
...
WeightTableBasedShippingList.prototype.Break_Create = function()
{
	var record;
...
WeightTableBasedShippingList.prototype.Break_Insert = function( item, callback, delegator )
{
	...
	WeightTableBasedShippingBreak_Insert( method_record.id, item.record.mmbatchlist_fieldlist, callback, delegator );
}

WeightTableBasedShippingList.prototype.Break_Save = function( item, callback, delegator )
{
	WeightTableBasedShippingBreak_Update( item.record.id, item.record.mmbatchlist_fieldlist, callback, delegator );
}

WeightTableBasedShippingList.prototype.Break_Delete = function( item, callback, delegator )
{
	WeightTableBasedShippingBreak_Delete( item.record.id, callback, delegator );
}

WeightTableBasedShippingList.prototype.Break_FindIndex_Params = function( item )
{
...
WeightTableBasedShippingList.prototype.Break_FindIndex_Compare = function( item, params )
{
	var method_record = this.GetListItemRecord_Parent( item.index );
...
WeightTableBasedShippingList.prototype.onCreateRootColumnList = function()
{
...
WeightTableBasedShippingList.prototype.CreateColumnList_Breaks = function()
{
	var columnlist =
	[
...
WeightTableBasedShippingList.prototype.DisplayData_NoData = function()
{
